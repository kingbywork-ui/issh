...
import { TerminalDecorator, BaseTerminalTabComponent, XTermFrontend, SessionMiddleware } from 'issh-terminal'
import { SSHProfile, SSHTabComponent, PasswordStorageService } from 'issh-ssh'
...
export class AutoSudoPasswordMiddleware extends SessionMiddleware {
    ...
    private pasteHint = `${colors.black.bgBlackBright(' issh ')} ${colors.gray('Press Enter to paste saved password')}`
