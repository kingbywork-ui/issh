...
import ISSHCorePlugin, { ConfigProvider, HotkeyProvider, TabContextMenuItemProvider, CLIHandler } from 'issh-core'
...
export { TerminalColorScheme } from 'issh-core' // was previously defined in this plugin
