export const PLUGIN_BLACKLIST = [
    ...
    'terminus-clickable-links', // now bundled with issh
    'tabby-clickable-links', // now bundled with issh
    'terminus-clickable-ips', // broken, functionality now bundled with issh
